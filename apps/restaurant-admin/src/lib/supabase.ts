 ...
 * instead of awaiting `getSession()` on every call. Mirrors
 * apps/super-admin/src/lib/supabase.ts.
 */
...
/** Synchronous accessor for the current Supabase session's access_token. */
